...
public class Combate {
	...
	public int getNivelDaPeça(String nomeDaPeça) {
		...
		switch (nomeDaPeça) {
			case "Armeiro" -> nivel = armeiro1.getNivel();
			case "Soldado" -> nivel = soldado1.getNivel();
			case "Espião" -> nivel = espiao.getNivel();
			case "Marechal" -> nivel = marechal.getNivel();
			case "Bomba" -> nivel = bomba1.getNivel();
			case "Bandeira" -> nivel = bandeira.getNivel();
		}
		return nivel;
	}
